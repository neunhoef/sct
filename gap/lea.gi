...
##
##  Implementation stuff for LEA officer analysis
##
#############################################################################
...
InstallMethod( Sunflower, "for a LEA search and two ints",
  [ IsLEASearch, IsInt, IsInt ],
function(r,flowerlimit,timeout)
